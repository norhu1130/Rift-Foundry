"""Focused metadata regressions for Heimerdinger's Cog."""
...
def test_heimerdinger_locked_model_metadata() -> None:
    """Require complete capability declaration and three local sources."""
    cog = create_default_registry(ROOT).require_cog("Heimerdinger")
